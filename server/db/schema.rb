...
ActiveRecord::Schema.define(version: 2020_03_14_151303) do
  ...
  create_table "result_units", force: :cascade do |t|
    ...
    t.bigint "result_id"
    t.index ["result_id"], name: "index_result_units_on_result_id"
  end
  ...
  create_table "workouts", force: :cascade do |t|
    ...
    t.index ["plan"], name: "index_workouts_on_plan", using: :gin
  end

  add_foreign_key "result_units", "results"
  add_foreign_key "results", "exercises"
  add_foreign_key "results", "users"
  add_foreign_key "results", "workouts"
  add_foreign_key "workouts", "users", column: "author_id"
end
